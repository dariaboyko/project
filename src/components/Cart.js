...
function Cart() {
  ...
  return (
    <div className="cart">
      <button className="cart__button" onClick={()=>setWindow(!window)}>
      <svg
      ...
      >
        ...
        {window&&<div className="cart--window">
          <p className="cart--window__title">Shopping Cart</p>
          <p className="cart--window__subtitle">Checkout is almost done!</p>
          <div></div>
          <div className="cart--bottom">
            <p>Total amount: <span className="bold">0 ptc.</span></p>
            <p>Total price: <span className="bold">0$</span></p>
          </div>
            <button className="cart--window__button">Buy</button>
          </div>}
    </div>
  );
}
